...
\newpage
    ...
    % TODO Trzeba to skompletować i opisać kilka wybranych pozycji (max 1 strona).
...
\newpage
    ...
    % TODO Uzupełnić referencje.

    \begin{thebibliography}{9}
        \bibitem[Wąs]{refs:social-distances-1} - Social Distances
        \bibitem[Wąs]{refs:social-distances-2} - Social Distances II
    \end{thebibliography}
\end{document}
